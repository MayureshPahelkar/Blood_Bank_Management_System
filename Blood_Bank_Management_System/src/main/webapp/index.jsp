...
<div class="header">
   <a href="#default" class="logo">
             <img class="logo" src="<%= request.getContextPath() %>/images/Logo1.png" alt="Logo"/>
        </a>
...
<div style="max-width:100%">
  <img class="mySlides" src="<%= request.getContextPath() %>/images/slide1.jpg">
<img class="mySlides" src="<%= request.getContextPath() %>/images/slide2.png">
</div>
<script>
var myIndex = 0;
carousel();
